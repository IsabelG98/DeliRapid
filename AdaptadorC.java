...
public class AdaptadorC extends BaseAdapter {
    ...
    public AdaptadorC(Context contexto, String[][] datos, int[] imagenes) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final View vista = inflater.inflate(R.layout.elemento_listac,null);
